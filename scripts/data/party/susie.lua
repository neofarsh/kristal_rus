...
function character:drawPowerStat(index, x, y, menu)
    if index == 1 then
        ...
        love.graphics.print("Грубость:", x, y)
        if Game.chapter == 1 then
    ...
    elseif index == 2 then
        ...
        Draw.draw(icon, x-26, y+6, 0, 2, 2)
        if Game.chapter == 1 then
            love.graphics.print("Грубость:", x, y, 0, 0.8, 1)
            love.graphics.print("100", x+130, y)
        elseif Game.chapter == 2 then
            love.graphics.print("Лиловая:", x, y, 0, 0.8, 1)
            love.graphics.print("Да", x+130, y)
        end
        return true
    elseif index == 3 then
