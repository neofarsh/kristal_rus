...
function character:init()
    ...
    if Game.chapter == 1 then
        self.title = "Одинокий принц\nИз тёмного мира.\nНе имеет подданных."
    elseif Game.chapter == 2 then
        self.title = "Тёмный принц\nИз тёмного мира.\nЗавёл друзей."
    elseif Game.chapter == 3 then
        self.title = "Тёмный принц\nИз тёмного мира.\nЕсть друзья."
    else
        self.title = "Тёмный герой\nВершащий судьбу\nс клинком."
    end
...
function character:getTitle()
    if Game.chapter == 1 then
        if self:checkWeapon("ragger") then
            return "УР"..self.level.." Колючий принц\nНаносит урон своим\nшершавым шарфом."
        elseif self:checkWeapon("daintyscarf") then
            return "УР"..self.level.." Пушистый принц\nСлаб, но умеет\nхорошо исцелять."
        end
    end
...
function character:drawPowerStat(index, x, y, menu)
    if index == 1 then
        ...
        elseif Game.chapter == 2 then
            ...
            Draw.draw(icon, x-26, y+6, 0, 2, 2)
            love.graphics.print("Милота:", x, y)
    ...
    elseif index == 2 then
        ...
        Draw.draw(icon, x-26, y+6, 0, 2, 2)
        love.graphics.print("Пушистость:", x, y, 0, 0.8, 1)
    ...
    elseif index == 3 then
        ...
        Draw.draw(icon, x-26, y+6, 0, 2, 2)
        love.graphics.print("Отвага:", x, y)
