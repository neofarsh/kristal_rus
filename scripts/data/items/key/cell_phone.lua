...
function item:init()
    ...
    self.shop = ""
    -- Menu description
    self.description = "Используется для звонков."
...
function item:onWorldUse()
    Game.world:startCutscene(function(cutscene)
        ...
        cutscene:text("* (Вы попытались позвонить по телефону.)", nil, nil, {advance = false})
        cutscene:wait(40/30)
        ...
        cutscene:text("* Какие-то бессмысленные звуки.")
    end)
end
